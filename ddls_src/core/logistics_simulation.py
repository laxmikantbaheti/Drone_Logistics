...
class TimeManager:  # Placeholder for type hinting if not imported
    def __init__(self, initial_time: float = 0.0): pass

    def reset_time(self, new_initial_time: float = 0.0): pass

    def advance_time(self, delta_time: float): pass

    def get_current_time(self) -> float: return 0.0
